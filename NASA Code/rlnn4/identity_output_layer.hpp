 ...
 * @author Marcus Edel
 *
 * Definition of the IdentityOutputLayer class also known as fully-connected layer or
 ...
 */
#ifndef MLPACK_METHODS_ANN_LAYER_ID_OUTPUT_LAYER_HPP
#define MLPACK_METHODS_ANN_LAYER_ID_OUTPUT_LAYER_HPP
...
/**
 * Implementation of the IdentityOutputLayer class. The IdentityOutputLayer class represents a
...
>
class IdentityOutputLayer
{
 public:
  /**
   * Create the IdentityOutputLayer object using the specified number of units.
   *
...
/////! TMP
 void OutputClass(InputDataType& input, OutputDataType& output)
  {
    output = input;
...
>
class LayerTraits<IdentityOutputLayer<InputDataType, OutputDataType> >
{
 public:
