...
\par In addition to the performance of the training algorithms, the time the CE takes to run an iteration is also a crucial evaluation point. %\textbf{\textit{[Rephrase this probably, it seems weird]}}. 
