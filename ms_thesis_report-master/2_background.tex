...
\clearpage
	...
	\begin{figure}
		...
		\caption{Four potential communication channels.}\label{fig:exampleCommGoals}
	\end{figure}
	\end{landscape}
	...
	\clearpage
	\subsection {GANS, and evaluating the utility of them \textbf{\textit{[retitle]}}}
	...
	\par In addition to making GANs more robust, work has gone into combining the concept with other ML and DL architectures. Some of the interesting alternate GANs are DCGAN \cite{radford2015unsupervised}, which introduces Convolutional Neural Networks (CNNs) to the GAN, and Adversarially Learned Inference (ALI), which introduces a latent representation of the data in order to \textit{\textbf{[finish explanation of ]}}\cite{ALI_encdec_inference}.
